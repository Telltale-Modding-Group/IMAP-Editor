...
namespace Telltale_IMAP_Editor.Utillities
{
    /// <summary>
    ...
    public class IOManagement
    {
        ...
        /// <summary>
        /// Opens a SaveBrowserDialog for the user to save a file path with a specified file extension.
        /// </summary>
        /// <param name="newFilePath"></param>
        /// <param name="extensionFilter"></param>
        /// <param name="dialogTitle"></param>
        public static void SaveFilePath(ref string newFilePath, string extensionFilter, string dialogTitle = "Save a File")
        {
            //open a file dialog
